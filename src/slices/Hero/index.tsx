...
const Hero: FC<HeroProps> = ({ slice }) => {
  ...
  return (
    ...
    <div className="relative z-10 max-w-[800px]">
        ...
        font-semibold tracking-[1px] uppercase mb-6">{slice.primary.header} Leeds & West Yorkshire</div>
        <h1 className="  font-(--font-display) title-text text-(--clr-white) mb-6"> <PrismicRichText field={slice.primary.text} /> Carpets & Upholstery That Look <em className="text-(--clr-gold) font-normal">Brand New</em> Again</h1>
        <p className="text-2xl text-[rgba(255,255,255,0.7)] leading-[1.7] max-w-[580px] mt-0 mx-auto mb-10"> <PrismicRichText field={slice.primary.description} />Professional deep cleaning for homes, offices, and commercial spaces. Jamin&apos;s delivers results you can see and feel — no shortcuts, just spotless.</p>
