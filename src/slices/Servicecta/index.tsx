    ...
    <div className="max-w-[1100px] my-0 mx-auto ">
        ...
        <div className="grid gap-6 mt-12 grid-cols-[repeat(auto-fit,minmax(240px,1fr))]">
            <div className="bg-(--clr-cream) p-9 relative overflow-hidden transition-all duration-300 ease-[ease] before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-1 before:bg-(--clr-forest) before:scale-x-0 before:transition-all before:duration-300 before:ease-[ease] origin-left hover:before:scale-x-[1] hover:-translate-y-1 hover:hadow-[0_12px_32px_rgba(0,0,0,0.08)]">
                ...
                <h3 className="font-(--font-display) text-[1.3rem] text-(--clr-white) mb-[0.8rem]">Carpet Cleaning</h3>
            ...
            <div className="bg-(--clr-cream) p-9 relative overflow-hidden transition-all duration-300 ease-[ease] before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-1 before:bg-(--clr-forest) before:scale-x-0 before:transition-all before:duration-300 before:ease-[ease] origin-left hover:before:scale-x-[1] hover:-translate-y-1 hover:hadow-[0_12px_32px_rgba(0,0,0,0.08)]">
                ...
                <h3 className="font-(--font-display) text-[1.3rem] text-(--clr-white) mb-[0.8rem]">Upholstery Cleaning</h3>
            ...
            <div className="bg-(--clr-cream) p-9 relative overflow-hidden transition-all duration-300 ease-[ease] before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-1 before:bg-(--clr-forest) before:scale-x-0 before:transition-all before:duration-300 before:ease-[ease] origin-left hover:before:scale-x-[1] hover:-translate-y-1 hover:hadow-[0_12px_32px_rgba(0,0,0,0.08)]">
                ...
                <h3 className="font-(--font-display) text-[1.3rem] text-(--clr-white) mb-[0.8rem]">Rug Cleaning</h3>
            ...
            <div className="bg-(--clr-cream) p-9 relative overflow-hidden transition-all duration-300 ease-[ease] before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-1 before:bg-(--clr-forest) before:scale-x-0 before:transition-all before:duration-300 before:ease-[ease] origin-left hover:before:scale-x-[1] hover:-translate-y-1 hover:hadow-[0_12px_32px_rgba(0,0,0,0.08)]">
                ...
                <h3 className="font-(--font-display) text-[1.3rem] text-(--clr-white) mb-[0.8rem]">Commercial Cleaning</h3>
