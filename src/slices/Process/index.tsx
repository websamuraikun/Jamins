      ...
      <div className="container text-center">
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(220px,1fr))] gap-8 mt-12">
          ...
          <div className="text-center p-6">
            ...
            <p className="text-[0.9rem] text-[rgba(255,255,255,0.6)] leading-[1.6]">
              Call or message us for a free, no-obligation quote. Tell us what
              needs cleaning and we&apos;ll give you an honest price.
            </p>
          </div>
          <div className="text-center p-6">
            <div className="font-(--font-display) text-[3rem]  text-(--clr-gold) opacity-[0.3] mb-2">
            ...
            <p className="text-[0.9rem] text-[rgba(255,255,255,0.6)] leading-[1.6]">
              We&apos;ll arrive at a time that suits you, fully equipped and
              ready to go. Our deep cleaning process takes care of everything.
            </p>
          </div>
          <div className="text-center p-6">
            <div className="font-(--font-display) text-[3rem]  text-(--clr-gold) opacity-[0.3] mb-2">
            ...
            <h3 className="text-[1.1rem] font-bold mb-2.5">
              Enjoy the Results
            </h3>
            <p className="text-[0.9rem] text-[rgba(255,255,255,0.6)] leading-[1.6]">
              Sit back and enjoy carpets and upholstery that look and feel like
