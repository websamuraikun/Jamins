...
const Contact: FC<ContactProps> = ({ slice }) => {
  return (
    ...
    <div className="container">
        ...
        <a href={`${slice.primary.telephone}`} className="cta-phone">{slice.primary.telephone}</a>
        <div className="hero-buttons flex gap-4 wrap justify-center" >
            <a href={`tel:${slice.primary.telephone}`} className="btn btn-primary">
            ...
            <a href={`mailto:${slice.primary.email}`} className="btn btn-outline text-white border-[gba(255,255,255,0.3)]" >
                Email Us
            </a>
        </div>
    </div>
